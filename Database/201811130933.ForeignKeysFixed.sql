...
ALTER TABLE [dbo].[CustomersPaymentTypes] DROP CONSTRAINT [FK__Customers__Payme__5535A963]
...
ALTER TABLE [dbo].[EmployeesTrainingPrograms] DROP CONSTRAINT [FK__Employees__Train__5070F446]
