...
class ProductCard extends React.Component {
    ...
    productClickEvent = (e, id) => {
        this.setState({ productIdClickedOn: id })
        this.props.history.push(`/Product/${id}`);
        console.log('e', e);
        console.log('state', this.state.productIdClickedOn);
    }
    ...
    render() {
        ...
        const productData = this.state.products.map(prod => {
            return (
                ...
                < div key={prod.id} className="Pcards" >
                    <div className="col-sm-4 btn" onClick={e => this.productClickEvent(e, prod.id)}>
        ...
        console.log('productdata', this.state.products);
